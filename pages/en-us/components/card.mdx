...
<Row style={{ flexWrap: 'wrap' }} justify="space-around">
  <Card width="330px">
    <h4>MMStudio Widgets</h4>
    <p>Modern and minimalist React UI library.</p>
    <Card.Footer>
      <Link color target="_blank" href="https://github.com/taoqf/widgets">Visit source code on GitHub.</Link>
    </Card.Footer>
  </Card>
  <Card width="330px" type="dark">
    ...
    <p>Modern and minimalist React UI library.</p>
    <Card.Footer>
      <Link target="_blank" href="https://github.com/taoqf/widgets">Visit source code on GitHub.</Link>
    </Card.Footer>
  </Card>
</Row>
`}
...
<Card width="400px">
  ...
  <Text h4 style={{ marginBottom: '0' }}>MMStudio Widgets</Text>
  <Text type="secondary" small>Modern and minimalist React UI library.</Text>
  <Card.Footer>
    <Link block target="_blank" href="https://github.com/taoqf/widgets">Visit source code on GitHub.</Link>
  </Card.Footer>
</Card>
`}
/>
