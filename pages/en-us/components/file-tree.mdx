...
import Film from '@geist-ui/react-icons/film';
...
<Playground
	title="Custom icons"
	desc="Use custom icons"
	scope={{ Tree, Github, Film }}
	code={`
<Tree>
  <Tree.Folder name="Chris Columbus" icon={<Github />}>
    <Tree.File name="The Fast and the Furious I" icon={<Film />} />
    <Tree.File name="The Fast and the Furious II" icon={<Film />} />
    <Tree.File name="The Fast and the Furious III" icon={<Film />} />
  </Tree.Folder>
  <Tree.Folder name="Rob Cohen" expand icon={<Github />}>
    <Tree.File name="Harry Potter I" icon={<Film />} />
    <Tree.File name="Harry Potter II" icon={<Film />} />
  </Tree.Folder>
</Tree>
`}
/>
...
| **icon**           | custom icon       | `ReactNode`      | -                                 | -       |
| **expand**         | expand by default | `boolean`        | -                                 | -       |
| **extra**          | extra message     | `string`         | -                                 | -       |
| ...                | native props      | `HTMLAttributes` | `'id', 'title', 'className', ...` | -       |
