...
<Image width={540} height={160}
  src="https://mmstudio.vercel.app/images/custom-domains.png" />
`}
/>
...
<Playground
	...
	code={`
<Image.Browser url="https://mmstudio.vercel.app/en-us/guide/introduction" anchorProps={{ rel: 'nofollow' }}>
...
<Playground
	...
	scope={{ Image, Display, Code }}
	code={`
<Image.Browser url="https://mmstudio.vercel.app/en-us/guide/introduction" invert>
  <Image width={540} height={246} src="https://user-images.githubusercontent.com/11304944/76085431-fd036480-5fec-11ea-8412-9e581425344a.png" />
</Image.Browser>
`}
/>
