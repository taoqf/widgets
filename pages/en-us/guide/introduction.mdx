...
**Geist UI** is a React implementation for <Link rel="nofollow" target="_blank" href="https://github.com/geist-org/style">styles</Link>
...
Geist UI is an open-source design system for building modern websites and applications, all our projects are open source.
