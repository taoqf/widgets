...
### MMStudio widgets on the Server

All Components of `@mmstudio/widgets` are compatible with **Server Render**. In fact, the document you see now is rendered by the server.
