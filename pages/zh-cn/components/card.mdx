...
<Row style={{ flexWrap: 'wrap' }} justify="space-around">
  <Card width="330px">
    ...
    <p>现代化、极简风格的 UI 库。</p>
    <Card.Footer>
      <Link color target="_blank" href="https://github.com/geist-org/react">在 GitHub 上查看源码</Link>
    </Card.Footer>
  </Card>
  <Card width="330px" type="dark">
    ...
    <p>现代化、极简风格的 UI 库。</p>
    <Card.Footer>
      <Link target="_blank" href="https://github.com/geist-org/react">在 GitHub 上查看源码</Link>
    </Card.Footer>
  </Card>
</Row>
`}
...
<Card width="400px">
  ...
  <Card.Footer>
    <Link block target="_blank" href="https://github.com/geist-org/react">在 GitHub 上查看源码</Link>
  </Card.Footer>
</Card>
`}
/>
