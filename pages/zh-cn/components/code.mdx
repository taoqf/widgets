...
<Playground
	...
	scope={{ Code }}
	code={`
<p>Run <Code>npm i @mmstudio/widgets</Code> to install.</p>
`}
/>
...
<Playground
	...
	code={`
() => {
  const codes = \`npm i @mmstudio/widgets
yarn add @mmstudio/widgets\`
...
<Playground
	...
	code={`
() => {
  const codes = \`npm i @mmstudio/widgets npm i @mmstudio/widgets npm i @mmstudio/widgets
yarn add @mmstudio/widgets\`
  return <Code block width="50%">{codes}</Code>
}
`}
