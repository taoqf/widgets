...
**Geist UI** 是以 <Link rel="nofollow" target="_blank" href="https://github.com/geist-org/style">Geist 样式库</Link> 为基础实现的 React 版本，
...
Geist UI 一个用于构建现代网站和应用程序的开源设计系统，且所有项目都是开源的。
